...
def merge_json_files(source_folder, target_folder, dataset_info_file):
    ...
    output_filename = f"{parent_folder_name}-{base_filename}-pretraining-chunks.json"
    ...
    dataset_info = {
        f"{parent_folder_name}-{base_filename}-pretraining-chunks.json": {
...
# 示例用法
source_folder = '/root/rag_project/data/pretraining_chunks/安徽合肥公共资源交易中心/政策'  # 源文件夹路径
